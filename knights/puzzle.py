...
And(Implication(AKnight,And(AKnave,BKnave)), Implication(And(AKnave,BKnave),AKnight))
...
And(Implication(BKnight, Or(And(AKnave,BKnight),And(AKnight,BKnave))),Implication(Or(And(AKnave,BKnight),And(AKnight,BKnave)),BKnight))
)
